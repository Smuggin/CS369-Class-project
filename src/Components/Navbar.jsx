      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <span className='text-black -mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 text-2xl'>E<span className='text-red-700'>com</span></span>
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12 justify-items-end">
